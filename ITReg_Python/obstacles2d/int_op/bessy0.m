...
if ~isempty(ind1)
    ...
    if nargin<2
        ...
        bessj0xx = bessj0x(ind1);
    end
    ans(ind1) = TWOOPI * log(xx).*bessj0xx + polevl(z, YP) ./ p1evl(z, YQ);
end
if ~isempty(ind2)
    xx = x(ind2);
    one = ones(size(ind2));
