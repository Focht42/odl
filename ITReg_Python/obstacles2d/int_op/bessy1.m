...
if ~isempty(ind1)
    ...
    if nargin<2
        ...
        bessj1xx = bessj1x(ind1);
    end

    w = w + TWOOPI * ( bessj1xx .* log(xx)  -  ones(size(ind1))./xx );
    ans(ind1) =w;
end
if ~isempty(ind2)
    xx = x(ind2);
